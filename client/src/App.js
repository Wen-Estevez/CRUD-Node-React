    ...
    <div className="card text-center">
      ...
      <div className="card-body">
        <div className="input-group mb-3">
          ...
          className="form-control" value={nombre} placeholder="Ingrese el nombre del empleado" aria-label="Username" aria-describedby="basic-addon1"/>
        </div>
      ...
      <div className="card-footer text-muted">
        {
          editar? 
          <div>
          <button className='btn btn-primary m-2' onClick={update}>Actualizar</button> 
          <button className='btn btn-outline-secondary m-2' onClick={limpiarCampos}>Cancelar</button>
          </div>
          :<button className='btn btn-success' onClick={add}><i class="bi bi-cloud-arrow-down"></i> Registrar</button>
        }
          ...
          empleadosList.map((val,key)=>{
            return <tr key={val.id}>
                    ...
                    <div className="btn-group" role="group" aria-label="Basic example">
                      ...
                      className="btn btn-outline-secondary">Editar</button>
